...
class DiscoveryServer:
    ...
    def send_discover(self):
        ...
        for port in self.robot_ports:
            self.sock.sendto(data, ('172.20.10.5', port)) #Enviamos el mensaje de descubrimiento a la dirección de broadcast en cada uno de los puertos que los robots están escuchando. Esto permite que cualquier robot en la red que esté escuchando en esos puertos reciba el mensaje y pueda responder.
