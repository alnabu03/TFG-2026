...
class DiscoveryServer:
    def __init__(self):
        ...
        self.send_period = 30.0 #Cada cuántos segundos se envía un mensaje de descubrimiento. Esto controla la frecuencia con la que el servidor busca nuevos robots en la red.
    ...
    def send_discover(self):
        ...
        for port in self.robot_ports:
            self.sock.sendto(data, ('172.20.10.255', port)) #Enviamos el mensaje de descubrimiento a la dirección de broadcast en cada uno de los puertos que los robots están escuchando. Esto permite que cualquier robot en la red que esté escuchando en esos puertos reciba el mensaje y pueda responder.
